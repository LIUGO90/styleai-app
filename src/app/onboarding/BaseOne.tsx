...
//   const [hasAppleName, setHasAppleName] = useState<boolean>(false);
...
//       if (user) {
//         // 首先检查是否从 Apple Sign In 获取了姓名
//         const appleFullName = user.user_metadata?.full_name;

//         if (appleFullName && appleFullName !== "Apple User") {
//           // 如果 Apple 提供了姓名，自动保存并跳过此页面（符合Apple审核要求）
...
//           await AsyncStorage.setItem("userName", appleFullName);

//           // 自动跳转到下一步，不显示输入界面
//           // 这是Apple审核要求：不得要求用户重新提供已有信息
//           router.push({
//             pathname: "/onboarding/BaseTwo",
//             params: { username: appleFullName },
//           });

//           return; // 阻止继续执行，不渲染输入UI
//         } else {
//           // 如果 Apple 没有提供姓名，尝试从 profile 加载
...
//               {"\n\n"}
//               {hasAppleName ? "Confirm or edit your name:" : "What's your name?"}
//             </Text>
...
//                 autoFocus={!hasAppleName}
//               />
//               {hasAppleName && (
//                 <Text className="text-sm text-gray-500 mt-2">
//                   This name is from your Apple account. You can change it if you'd like.
//                 </Text>
//               )}
//             </View>
//           </View>
